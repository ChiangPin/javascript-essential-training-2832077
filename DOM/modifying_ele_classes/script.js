...
//Element.className => two challenges, 1) u might wiping out all the classes; 2) react is using the term className
//Element.classList => Better approach, return DOMTokenList collection (add,toggle,remove,replace)
